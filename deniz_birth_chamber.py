...
"name" : "F&B fig 2D noniso",
"num_osc" : 50, # number of oscillators in chain[default = 100 or 150], 80 in paper

#set_freq
"freq_dist" : "exp", #linear or exp
"roughness_amp" : 0,
"omega_0" : 5, # char frequency of lowest oscillator [default = 2*np.pi] 
"omega_N" : 25, # char frequency of highest oscillator [default = 5*(2*np.pi)] 
...
"beta_sigma" : 2.0 # [0 = isochronous as in V&D] --> std dev (normal dist w/ 0 mean) for beta_j... 
