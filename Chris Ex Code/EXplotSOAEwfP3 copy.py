...
[IN PROGRESS]; V.3 is aiming to better analyze phase info...]
Purpose: (Python) Analysis of SOAE waveform data, including 
some unconventional averaging routines.... ;-)
...
root= 'SOAE Data'         # root path to file
fileN = 'fwavef.JIrearSOAEwf2.CF1723.BW30.mat'
...
# --- coherence
if 1==1:
    fig5= plt.plot(freq/1000,coherence,'b-',lw=1,label='X')
    #fig4= plt.plot(freq/1000,specAVGp,'b-',lw=1,label='X')
